...
# Keep this the only executable enumeration - fm-spawn, fm-bootstrap, and
# fm-dispatch-select all read it. The provider FILE grammar is owned by
# docs/configuration.md "Provider environment files".
