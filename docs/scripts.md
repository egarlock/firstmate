...
| `fm-harness-policy.sh`   | Sourced single source of harness policy: verified-adapter allowlist, model/effort launch flags, process matching, and the copilot spawn-time version gate |
